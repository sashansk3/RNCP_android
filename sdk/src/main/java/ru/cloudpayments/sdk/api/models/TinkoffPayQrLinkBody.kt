...
data class TinkoffPayQrLinkBody(
	...
	@SerializedName("SuccessRedirectUrl") val successRedirectUrl: String = "", // Url успешной оплаты (мерчанта)
	@SerializedName("FailRedirectUrl") val failRedirectUrl: String = "", // Url неуспешной оплаты (мерчанта)
